...
<div style="width: 356px;">
    <form method="POST">
        <asp:TextBox ID="SearchTerm" runat="server" CssClass="form-control input-width-82" onkeypress="if(window.event.keyCode == 13) { this.parentElement.querySelector('input[type=submit]').click(); window.event.stopPropagation();}" />
