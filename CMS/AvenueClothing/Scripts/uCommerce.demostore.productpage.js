...
//var variantPrices = {};
//var defaultPrice = $( ".item-price" ).html();
...
//            		updateAddToCartButton($('#btnAddToBasket'), $('.variant'));
//            	}
...
//            failure
//        );
//    var lookupString = $( "#variation-collarsize :selected" ).val() + $( "#variation-colour :selected" ).val();
//    if(variantPrices[lookupString] != null) {
//        var newPrice = variantPrices[lookupString];
//        if (newPrice != "noVariantPrice") {
