...
public partial class CMSModules_ContinuousIntegration_Pages_Settings : GlobalAdminPage
{
    ...
    private void SaveIntegrationLogToEventLog(string eventType, string eventCode, string description)
    {
        ...
        EventLogProvider.LogEvent(eventType, CONTINUOUS_INTEGRATION, eventCode, description, RequestContext.RawURL, CurrentUser.UserID, CurrentUser.UserName,
