...
public partial class CMSModules_DataProtection_Pages_Consents_EditItem : CMSPage
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        htmlConsentShortText.ResolvedValue = Consent.GetConsentText(SelectedCulture).ShortText;
        htmlConsentFullText.ResolvedValue = Consent.GetConsentText(SelectedCulture).FullText;
    }
