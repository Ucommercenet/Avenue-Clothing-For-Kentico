...
public partial class CMSModules_MessageBoards_Controls_NewSubscription : CMSUserControl
{
    ...
    {
        var messageBoardActivityLogger = new MessageBoardActivityLogger();
        messageBoardActivityLogger.LogMessageBoardSubscriptionActivity(bi, bsi, DocumentContext.CurrentDocument);
    }
