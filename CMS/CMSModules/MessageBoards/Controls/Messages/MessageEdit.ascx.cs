...
public partial class CMSModules_MessageBoards_Controls_Messages_MessageEdit : CMSAdminEditControl
{
    ...
    private MessageBoardActivityLogger mMessageBoardActivityLogger = new MessageBoardActivityLogger();
    ...
    private void LogRatingActivity(double value)
    {
        ...
        {
            var ratingActivityLogger = new RatingActivityLogger();
            ratingActivityLogger.LogRating(value, currentDocument);
        }
    }
