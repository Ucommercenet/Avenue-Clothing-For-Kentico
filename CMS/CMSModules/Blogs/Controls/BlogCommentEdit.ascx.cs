...
public partial class CMSModules_Blogs_Controls_BlogCommentEdit : CMSUserControl
{
    ...
    private readonly BlogsActivityLogger mBlogsActivityLogger = new BlogsActivityLogger();
                        ...
                        if (chkSubscribe.Checked)
                        {
                            ...
                            if ((bpsi == null) || !bpsi.SubscriptionApproved)
                            {
                                ...
                                if (bpsi.SubscriptionApproved)
                                {
                                    ...
                                    mBlogsActivityLogger.LogBlogPostSubscriptionActivity(bpsi);
                                }
                            }
                            else
                            {
    ...
    protected string ValidateForm()
    {
        ...
        if ((mUseCaptcha) && (errorMessage == String.Empty))
        {
